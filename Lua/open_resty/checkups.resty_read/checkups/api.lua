...
local heartbeat       = require "upyun.resty.checkups.heartbeat"
local dyconfig        = require "upyun.resty.checkups.dyconfig"
local base            = require "upyun.resty.checkups.base"
local try             = require "upyun.resty.checkups.try"
local subsystem       = require "upyun.resty.subsystem"
...
function _M.create_checker()
    ...
    -- 忽略, 不会同步 status 到 nginx upstream block
